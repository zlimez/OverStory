...
namespace AnyPortrait
{
	...
	public class apSnapShotManager
	{
		...
		//[v1.4.5] 특정 속성만 복사할 수 있다.
		public bool Paste_Keyframe_MeshWithProps(apAnimKeyframe targetKeyframe,
												bool isProp_Verts,
												bool isProp_Pins,
												bool isProp_Transform,
												bool isProp_Visibility,
												...
												List<apModifiedPin> selectedModPins)
		{
			...
			return _clipboard_Keyframe.LoadWithProperties(targetKeyframe,
														isProp_Verts,
														isProp_Pins,
														isProp_Transform,
														isProp_Visibility,
