...
namespace AnyPortrait
{
	...
	public class apControlParamPresetUnit
	{
		...
		public void SetControlParam(apControlParam srcControlParam, int uniqueID)
		{
			...
			_isNonInterpolatedIndex = srcControlParam._isNonInterpolatedIndex;
												...
												)
		{
			...
			_isNonInterpolatedIndex = isNonInterpolatedIndex;
		...
		{	
			...
			{	
				...
				sw.WriteLine("NIPI" + (_isNonInterpolatedIndex ? "T" : "F"));
		...
		public void Load(List<string> loadedStringSet)
		{
			...
			for (int i = 0; i < loadedStringSet.Count; i++)
			{
				...
				try
				{
					...
					{
						_isNonInterpolatedIndex = strValue.StartsWith("T");
					}
