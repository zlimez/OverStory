...
namespace AnyPortrait
{
	...
	public static class apAutoRigUtil
	{
		...
		public static float GetVertRigWeight(apModifiedVertexRig targetVertRig, EnvelopeInfo envInfo, EnvelopeInfo nearestEnvInfo)
		{
			...
			//Debug.LogWarning("Auto Rig 계산 [" + envInfo._bone._name + "]");
			//Debug.Log("Vertex : Local > " + targetVertRig._renderVertex._vertex._pos + " / World(NoMod) : " + targetVertRig._renderVertex._pos_World_NoMod);
			//Debug.Log("Bone Env : Start : " + envInfo._posStart + " > End : " + envInfo._posEnd);
			//Debug.Log("Bone Local : " + envInfo._bone._defaultMatrix._pos + " / World(NoMod) : " + envInfo._bone._worldMatrix_NonModified.Pos);
