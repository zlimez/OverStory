...
namespace AnyPortrait
{
	...
	public partial class apSelection
	{
		...
		//추가 v1.4.5 : 마지막으로 선택했던 타임라인의 종류를 그대로 유지하여, AnimClip 선택시 활용한다.
		private enum LAST_ANIM_TIMELINE_TYPE { Unknown, ControlParam, ModTF, ModMorph, ModColor }
		private LAST_ANIM_TIMELINE_TYPE _lastAnimTimelineType = LAST_ANIM_TIMELINE_TYPE.Unknown;
		...
		//파라미터의 Int 변수
		private string[] _controlParam_IntegerTypeNames = new string[]{ "Interpolated", "Indexed" };
		...
		//public readonly string[] _captureProcessorNames = new string[] { "Version 1 (Legacy)", "Version 2" };
		...
		public void Clear()
		{
			...
			_lastAnimTimelineType = LAST_ANIM_TIMELINE_TYPE.Unknown;
