...
namespace AnyPortrait
{
	...
	public partial class apEditor : EditorWindow
	{
		...
		//추가 v1.4.6 : 에디터 UI 설정
		public enum SELECTED_TIMELINE_GUI_TYPE : int
		{
			None = 0,
			Flashing = 1,
		}

		public enum TIMELINE_DEFAULT_COLOR : int
		{
			Vivid = 0,
			SlightlyDark = 1,
		}

		public SELECTED_TIMELINE_GUI_TYPE _animUIOption_SelectedTimelineGUIType = SELECTED_TIMELINE_GUI_TYPE.Flashing;
		public TIMELINE_DEFAULT_COLOR _animUIOption_DefaultTimelineColor = TIMELINE_DEFAULT_COLOR.Vivid;
		...
		//추가 v1.4.6 : 캡쳐 옵션이 추가되었다.
		public enum CAPTURE_PROCESSOR : int
		{
			Version1 = 0,//이전 버전 (오류 다수)
		...
		public int _captureFocusOffsetPX_Y = 0;
