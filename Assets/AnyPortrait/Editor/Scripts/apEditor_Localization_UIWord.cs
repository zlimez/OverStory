...
{
	//public class apEditor_Localization_UIWord : EditorWindow
	//{
	//	// Members
	//	//------------------------------------------------------------------
	//	private static apEditor_Localization_UIWord s_window = null;
	...
	//	// Show Window
	//	//------------------------------------------------------------------
	//	//[MenuItem("Window/AnyPortrait/Localization [UI Word] Table", false, 62)]//<<사용할때만 이걸 켭시다.
	//	public static void ShowDialog()
	//	{
	//		CloseDialog();


	//		EditorWindow curWindow = EditorWindow.GetWindow(typeof(apEditor_Localization_UIWord), false, "Localization [UI Word] Table", true);
	//		apEditor_Localization_UIWord curTool = curWindow as apEditor_Localization_UIWord;
	...
	//		width -= 10;
	//		//Bake 설정
	//		EditorGUILayout.LabelField("Localization [UI Word] Table", GUILayout.Width(width));
	//		//X, Y 개수를 표시
	...
	//		{
	//			TextAsset enumAsset = AssetDatabase.LoadAssetAtPath<TextAsset>(apEditorUtil.ResourcePath_Text + "apLangPack_UI_Enum.txt");
	//			if (enumAsset != null)
	//			{
	...
	//		TextAsset textAsset = AssetDatabase.LoadAssetAtPath<TextAsset>(apEditorUtil.ResourcePath_Text + "apLangPack_UI.txt");
	...
	//			return;
	//		}
	//		//string filePath = Application.dataPath + "/Editor/AnyPortraitTool/Util/apLangPack_UI.txt";
	//		//string filePath_Enum = Application.dataPath + "/Editor/AnyPortraitTool/Util/apLangPack_UI_Enum.txt";

	//		string filePath = Application.dataPath + "/" + apEditorUtil.ResourcePath_Text_WithoutAssets + "apLangPack_UI.txt";
	//		string filePath_Enum = Application.dataPath + "/" + apEditorUtil.ResourcePath_Text_WithoutAssets + "apLangPack_UI_Enum.txt";
	...
	//			sw.WriteLine("Text Type,Text Index,1 English (영어),2 Korean (한국어),3 French (프랑스어),4 German (독일어),5 Spanish (스페인어),6 Italian (이탈리아어),7 Danish (덴마크어),8 Japanese (일본어),9 Chinese_Traditional (중국어-번체),10 Chinese_Simplified (중국어-간체),11 Polish (폴란드어)");
	//			TextSet curSet = null;
	//			for (int i = 0; i < _textSets.Count; i++)
	//			{
	//				curSet = _textSets[i];
	...
	//			sw.WriteLine("\tpublic enum UIWORD");
	//			sw.WriteLine("\t{");
	//			for (int i = 0; i < _textSets.Count; i++)
	//			{
	//				curSet = _textSets[i];
	...
	//			fi.CopyTo(Application.dataPath + "/../../LangPackBackUp_UI_" + DateTime.Now.Month + "_" + DateTime.Now.Day + "_" + DateTime.Now.Hour + "_" + DateTime.Now.Minute + "_" + DateTime.Now.Second + ".txt");
	//		}
	//		catch (Exception ex)
	//		{
