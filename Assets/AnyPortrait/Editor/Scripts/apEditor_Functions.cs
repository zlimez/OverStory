...
namespace AnyPortrait
{
	...
	public partial class apEditor : EditorWindow
	{
		...
		{	
			...
			Vector2 tmpPos1 = Vector2.zero;
			Vector2 tmpPos2 = Vector2.zero;
			...
			for (int i = 0; i < nLines; i++)
			{
				...
				if(curLine._direction == apGuideLines.LINE_DIRECTION.Horizontal)
				{
					...
					//변경 v1.4.4 : Ref를 이용
					tmpPos1 = new Vector2(0.0f, curLine._position);
					apGL.World2GL(ref pos1, ref tmpPos1);
					pos2.y = pos1.y;
				...
				else
				{
					...
					//변경 v1.4.4 : Ref를 이용
					tmpPos1 = new Vector2(curLine._position, 0.0f);
					apGL.World2GL(ref pos1, ref tmpPos1);
					pos2.x = pos1.x;
		...
		public void OnHotKeyUp()
		{
			//if(!_isHotKeyProcessable)
			//{
			//	Debug.Log("Key Up - HotKey > 재사용 가능");
			//}
		...
		public void SaveEditorPref()
		{
			...
			SavePref_Int("AnyPortrait_Capture_Processor",	(int)_captureProcessor, (int)DefaultCaptureProcessor);			
			//SavePref_Bool("AnyPortrait_Capture_PixelPerfect", _capturePixelPerfect, false);
			

			SavePref_Int("AnyPortrait_Capture_FocusOffsetX", _captureFocusOffsetPX_X, 0);
			SavePref_Int("AnyPortrait_Capture_FocusOffsetY", _captureFocusOffsetPX_Y, 0);
			...
			SavePref_Bool("AnyPortrait_SaveProjectWhenBaked", _isSaveProjectWhenBaked, false);
		...
		public void LoadEditorPref()
		{
			...
			_captureProcessor = (CAPTURE_PROCESSOR)EditorPrefs.GetInt("AnyPortrait_Capture_Processor",	(int)DefaultCaptureProcessor);
			//_capturePixelPerfect = EditorPrefs.GetBool("AnyPortrait_Capture_PixelPerfect", false);

			_captureFocusOffsetPX_X = EditorPrefs.GetInt("AnyPortrait_Capture_FocusOffsetX", 0);
			_captureFocusOffsetPX_Y = EditorPrefs.GetInt("AnyPortrait_Capture_FocusOffsetY", 0);
		...
		public void RestoreEditorPref()
		{
			...
			_captureProcessor = DefaultCaptureProcessor;
		...
		public static CAPTURE_PROCESSOR DefaultCaptureProcessor { get { return CAPTURE_PROCESSOR.Version2; } }
		...
		private void ProcessScreenCapture()
		{
			...
			if(isValid)
			{
				...
				//v1.4.6 프로세스에 따라서 다른 함수가 동작한다.
				if (_captureProcessor == CAPTURE_PROCESSOR.Version1)
				{
					//기존 버전
				...
				{
					//버전 2 [v1.4.6] - 개선되었다!
					result = Exporter.RenderToTexture_V2(
														targetMeshGroup,
														//curRequest._winPosX,
														//curRequest._winPosY,
														curRequest._srcSizeWidth,
														...
														//v1.4.6 추가
														//_capturePixelPerfect,
														curRequest._focusOffsetX,
														curRequest._focusOffsetY
														);
				}
