...
namespace AnyPortrait
{
	...
	public class apPullTouch
	{
		...
		public const float FRAME_TIME_60FPS = 0.0167f;
		...
		public void SetPos(Vector2 posW)
		{
			...
			//스무딩을 한다. [1.4.5]
			//초당 60프레임일때 50% 적용
			//초당 30프레임이면 100%를 적용해야한다. (보간 없이 적용)
			float lerp = Mathf.Clamp((Time.unscaledDeltaTime / FRAME_TIME_60FPS) * 0.5f, 0.02f, 1.0f);
			_posW = (_posW * (1.0f - lerp)) + (posW * lerp);
		}
