...
namespace AnyPortrait
{
	...
	public class apOptBoneWorldMatrix
	{
		...
		//변경 v1.4.4 : Ref를 이용하여 더 빠른 함수로 교체
		public virtual void MulPoint2(ref Vector2 dstPos, ref Vector2 srcPoint)
		{	
			//오버라이드를 하자
		}

		public virtual void InvMulPoint2(ref Vector2 dstPos, ref Vector2 srcPoint)
		{
			//오버라이드를 하자
		}
