...
namespace AnyPortrait
{
	public class apOptBoneWorldMatrix_Default : apOptBoneWorldMatrix
	{
		...
		//변경 v1.4.4 : Ref를 이용하여 속도 향상
		public override void MulPoint2(ref Vector2 dstPos, ref Vector2 srcPoint)
		{
			_mtx_Def.MulPoint2(ref dstPos, ref srcPoint);
		}
		public override void InvMulPoint2(ref Vector2 dstPos, ref Vector2 srcPoint)
		{
