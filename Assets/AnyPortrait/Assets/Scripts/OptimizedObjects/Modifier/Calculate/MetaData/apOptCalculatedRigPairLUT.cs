	...
	public class apOptCalculatedRigPairLUT
	{
		...
		public void Update()
		{
			...
			for (int i = 0; i < _nLUT; i++)
			{
				...
				//변경 v1.4.4 : 아주 약간의 성능 향상
				_cal_CurUnit._resultMatrix.SetAndMultiply3(	ref _parentTransform._vertMeshWorldNoModInverseMatrix,
															ref _cal_CurUnit._linkedBone._vertWorld2BoneModWorldMatrix,
															ref _parentTransform._vertMeshWorldNoModMatrix);
			}
		}
		...
		public void UpdateAsSyncBones()
		{
			...
			for (int i = 0; i < _nLUT; i++)
			{
				...
				//변경 v1.4.4 : 더 속도가 빠른 방식으로 계산
				_cal_CurUnit._resultMatrix.SetAndMultiply3(	ref _parentTransform._vertMeshWorldNoModInverseMatrix,
															ref _cal_CurUnit._syncBone._vertWorld2BoneModWorldMatrix,//[Sync]
															ref _parentTransform._vertMeshWorldNoModMatrix
															);
