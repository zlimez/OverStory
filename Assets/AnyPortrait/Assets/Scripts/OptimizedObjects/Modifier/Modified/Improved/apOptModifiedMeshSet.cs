...
namespace AnyPortrait
{
	...
	public class apOptModifiedMeshSet
	{
							...
							apPortrait portrait)
		{
			...
			{
				Bake_Physics(srcModMesh.PhysicParam, srcModMesh._vertWeights, srcModMesh, portrait);
			}
		...
		public void Bake_Physics(apPhysicsMeshParam srcPhysicParam, List<apModifiedVertexWeight> modVertWeights, apModifiedMesh srcModMesh, apPortrait portrait)
		{
			...
			subMod_Physics.Bake(srcPhysicParam, modVertWeights, srcModMesh, portrait);
		}
