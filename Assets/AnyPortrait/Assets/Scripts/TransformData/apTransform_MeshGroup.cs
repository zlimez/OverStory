...
namespace AnyPortrait
{
	...
	public class apTransform_MeshGroup
	{
		...
		public void AddWorldMatrix_Parent(apMatrix matrix_parentTransform, apMatrix matrix_parentTransformNoMod)
		{
			...
			_matrix_TF_ParentWorldWithoutMod.SetMatrix(matrix_parentTransformNoMod, false);//추가 v1.4.4
		}
		...
		public void MakeTransformMatrix()
		{
			...
			//TODO : _matrix_TF_ParentWorldWithoutMod 관련 코드를 apTransform_Mesh를 보고 작성할 것
			...
			//_matrix_TFResult_WorldWithoutMod.RMultiply(_matrix_TF_ParentWorld, true);//이전
			_matrix_TFResult_WorldWithoutMod.RMultiply(_matrix_TF_ParentWorldWithoutMod, true);//변경
		}
