...
namespace AnyPortrait
{
	...
	public class apDialog_SelectBonesForAutoRig : EditorWindow
	{
						...
						FUNC_SELECT_BONES_FOR_AUTO_RIG funcResult)
		{
			...
			{
				//Mod가 적용되지 않은 World Pos를 구해야한다.
				meshTransform._linkedRenderUnit.CalculateRenverVertsWorldPosNoMod(apRenderUnit.CALCULATE_NO_MOD_POS_REQUEST.RefreshWorldMatrix_Single);
			}
