...
namespace AnyPortrait
{
	...
	public class apHotKey
	{
		...
		/// <summary>
		/// [v1.4.5] 단축키 입력 후 포커스를 잃었다면, 그 직후의 Up 이벤트를 인식하지 못하여, 다음 Up 입력 전까진 Press 입력이 무시되어버린다.
		/// 이를 막기 위해 "키입력 직후" 포커스를 잃었다면 Up에 준하는 처리를 하자
		/// </summary>
		public void SetKeyReleasedForce()
		{
			_prevKey = KeyCode.None;
